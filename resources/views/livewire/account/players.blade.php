                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" id="new-my-player" class="btn btn-light mt-1" style="margin-right: 2em;">NUEVO ATLETA</button>
                        </div>
                    </div>
...
@push('js')
<script wire:ignore>
    document.getElementById('new-my-player').addEventListener('click', function(){
        Swal.fire({
                title: 'Mi nuevo ATLETA',
                html: `<div class="px-2">
