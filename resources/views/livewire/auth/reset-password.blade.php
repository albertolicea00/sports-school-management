                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Cambia tu contraseñá
                                </h4>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="update" class="text-start">
                                ...
                                <div
                                    ...
                                    <label class="form-label">Confirma la contraseñá</label>
                                ...
                                <p class="mt-4 text-sm text-center">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="text-primary text-gradient font-weight-bold">Solicita una</a>
                                </p>
                            </form>
                        </div>
                    </div>
